...
const DataCard=({time, inputText})=>{
    return (
      <div className="mx-2 shadow-lg shadow-cyan-500/50 flex-rows bg-black w-84 sm:w-84 justify-center  place-content-center border-black border-2 rounded-3xl my-2 drop-shadow-xl shadow-cyan-500/50 hover:border-2 hover:ring-2 hover:shadow-cyan-500/80  ">
